  ...
  return (
    <footer className="w-full py-xl px-lg flex flex-col md:flex-row justify-between items-center gap-md bg-surface-container-lowest border-t border-outline-variant mt-auto">
      <div className="flex flex-col items-center md:items-start gap-sm">
        <span className="font-h3 text-h3 text-primary">SKIBBLE INFRATECH OPC PRIVATE LIMITED</span>
        <span className="font-caption text-caption text-on-surface-variant">© 2026 SKIBBLE INFRATECH OPC PRIVATE LIMITED. All rights reserved.</span>
      </div>
